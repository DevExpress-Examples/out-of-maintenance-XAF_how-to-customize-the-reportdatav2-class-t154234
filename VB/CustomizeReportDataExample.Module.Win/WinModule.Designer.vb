Namespace CustomizeReportDataExample.Module.Win
    Partial Public Class CustomizeReportDataExampleWindowsFormsModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' CustomizeReportDataExampleWindowsFormsModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(CustomizeReportDataExample.Module.CustomizeReportDataExampleModule))
